...
$.fn.validatebox.defaults={required:false,validType:null,missingMessage:"此处不能为空.",invalidMessage:null,rules:{email:{validator:function(_333){
...
},message:"请输入一个有效的邮件地址."},url:{validator:function(_334){
...
},message:"请输入一个有效的URL."},length:{validator:function(_335,_336){
