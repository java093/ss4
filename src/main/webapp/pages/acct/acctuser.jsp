...
<script type="text/javascript" src="<%=baseUrl%>/pages/acct/acctuser.js"></script>
  ...
  <tr>
    <td>
		<div id = "divid" class="tbar">
			...
			<a href="#" class="easyui-linkbutton" onclick="updatePwd();" icon="icon-edit" plain="true">修改密码</a>
			<a id = "" href="#" class="easyui-linkbutton" onclick="deleteAcctUser();" icon="icon-cancel" plain="true">删除</a>
			<a href="#" class="easyui-linkbutton" onclick="auth();" icon="icon-edit" plain="true">人员授权</a>
