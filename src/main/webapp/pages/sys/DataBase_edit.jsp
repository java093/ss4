...
<script type="text/javascript"
	src="<%=baseUrl%>/pages/sys/DataBase_edit.js"></script>
<script type="text/javascript">
...
<body>
	<div id="addPrivilege" icon="icon-save"
		...
		<form method="get" name="editDataBase" id="editDataBase">
				...
				<td colspan="3" align="center">
					<div class="tbar">
						<a href="#" class="easyui-linkbutton" icon="icon-ok"
							...
							class="easyui-linkbutton" icon="icon-save" onclick="editDB();"
			...
			<table cellpadding="0" cellspacing="0" border="0" id="uiform"
				...
				<tr>
					...
					<td width="50%" class="form_content"><input name="dbtype"
						readonly="readonly" value="jdbc:oracle:thin" style="width: 140px;"><font
						color="red"> *</font></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td width="50%" class="form_content"><input name="password"
						type="password" style="width: 140px;" onchange="savedisabled()"><font color="red">
							*</font> </input></td>
				</tr>
				<tr>
