...
//路径
baseUrl = "<%=baseUrl%>";</script>
<script type="text/javascript"
	src="<%=baseUrl%>/pages/sys/informatica_insert.js"></script>
<script type="text/javascript">
...
<body>
	<div id="addPrivilege" icon="icon-save"
		...
		<form method="get" name="addInformatica" id="addInformatica">
			<tr>
				<td colspan="3" align="center">
					<div class="tbar">
						<a href="#" class="easyui-linkbutton" icon="icon-ok"
							...
							onclick="addInformatic();" plain="true" disabled="true" id="save"
							name="save">保存</a> <a href="#" class="easyui-linkbutton"
							icon="icon-redo" onclick="closeAdd();" plain="true">取消</a>
					</div>
				</td>
			</tr>
			...
			<table cellpadding="0" cellspacing="0" border="0" id="uiform"
				...
				<tr>
					...
					<td width="50%" class="form_content">
						...
						<select id="knowledge_base" name="knowledge_base"
						style="width: 145px;">
				...
				<tr>
					...
					<td width="50%" class="form_content"><input
						name="integration_server" type="text" style="width: 140px;"></input><font
						color="red"> *</font></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td width="50%" class="form_content"><input name="password"
						type="password" style="width: 140px;"></input><font color="red">
							*</font></td>
				</tr>
				<tr>
