...
<script type="text/javascript"
	src="<%=baseUrl%>/pages/mng/codemaster_add.js"></script>
<script type="text/javascript">
...
<body style="background: #EFF0F2">
	<form method="get" name="addCodeMasterForm" id="addCodeMasterForm">
				...
				<td>
					<div class="tbar">
						...
						<a href="#" class="easyui-linkbutton" icon="icon-save"
							onclick="addCodeMaster();" plain="true">保存</a> 
					...
					<table cellpadding="0" cellspacing="0" border="0" id="uiform"
						...
						<tr>
							...
							<td width="25%" class="form_content"><input  type="text"
								id="description" name="description" style="width: 140px;"></input><font color="red"> *</font></td>
						</tr>
						<tr>
