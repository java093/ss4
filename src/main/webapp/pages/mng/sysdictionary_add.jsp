...
<title>sysdictionary管理</title>
<script type="text/javascript">
//路径
baseUrl = "<%= baseUrl%>";

</script>
<script type="text/javascript" src="<%=baseUrl%>/pages/mng/sysdictionary_add.js"></script>
<script type="text/javascript">
</script>
</head>

<body style="background: #EFF0F2">
	<form method="get" name="addSysDictionaryForm"
		id="addSysDictionaryForm">
				...
				<td>
					<div class="tbar">
						...
						<a href="#" class="easyui-linkbutton" icon="icon-save"
							onclick="addSysDictionary();" plain="true">保存</a> 
				...
				<td>
					<table cellpadding="0" cellspacing="0" border="0" id="uiform"
						...
						<tr>
							...
							<td width="25%" class="form_content"><select id="dict_entry"
								name="dict_entry" onclick="changeWidth()" style="width: 144px;*width:146px;">
						...
						<tr>
							<td width="25%" class="form_title">字典子项：</td>
							<td width="25%" class="form_content"><input type="text" id="subentry" name="subentry" style="width: 140px;"></input><font color="red"> *</font></td>
						</tr>
						<tr>
						...
						<tr>
							<td width="25%" class="form_title">子项名称：</td>
							<td width="25%" class="form_content"><input type="text"
								id="dict_prompt" name="dict_prompt" style="width: 140px;"></input><font color="red"> *</font></td>
						</tr>
						<tr>
