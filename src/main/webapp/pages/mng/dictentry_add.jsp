...
<script type="text/javascript" src="<%=baseUrl%>/pages/mng/dictentry_add.js"></script>
<script type="text/javascript">
</script>
</head>

<body style="background: #EFF0F2">
	<form method="get" name="addDictentryForm" id="addDictentryForm">
				...
				<td>
					<div class="tbar">
						...
						<a href="#" class="easyui-linkbutton" icon="icon-save"
							onclick="addDictentry();" plain="true">保存</a> 
