...
<script type="text/javascript" src="<%=baseUrl%>/pages/mng/sysdictionary_edit.js"></script>
<script type="text/javascript">
</script>
</head>

<body style="background: #EFF0F2">
	<form method="get" name="updateSysdictionaryForm"
		id="updateSysdictionaryForm">
				...
				<td>
					<div class="tbar">
						...
						<a href="#" class="easyui-linkbutton" icon="icon-save"
							onclick="editSysdictionary();" plain="true">保存</a> 
					...
					<table cellpadding="0" cellspacing="0" border="0" id="uiform"
						...
						<tr>
							...
							<td width="25%" class="form_content"><select id="dict_entry"
								name="dict_entry" style="width: 144px;*width:146px;">
						...
						<tr>
							...
							<td width="25%" class="form_content"><input type="text" id="subentry" name="subentry" style="width: 140px;"
								></input><font color="red"> *</font></td>
						</tr>
						<tr>
