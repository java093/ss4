...
<title>CodeMasterDetail编辑</title>

<script type="text/javascript" src="<%=baseUrl%>/pages/mng/codemaster_detail_edit.js"></script>
...
<body style="background:#EFF0F2">
	...
	<table cellpadding="0" cellspacing="0" border="0" class="form_table">
		<tr>
  		<td colspan="3">
			<div class="tbar">
				<a href="#" class="easyui-linkbutton" icon="icon-save" onclick="codeDetailUpdate();" plain="true">保存</a>
