...
<title>con_tran_dict添加</title>
<script type="text/javascript">
//路径
baseUrl = "<%= baseUrl%>";

</script>
<script type="text/javascript" src="<%=baseUrl%>/pages/mng/con_tran_dict_add.js"></script>
<script type="text/javascript">
</script>
</head>

<body style="background: #EFF0F2">
	<form method="get" name="addCon" id="addCon">
				...
				<td>
					<div class="tbar">
						...
						<a href="#" class="easyui-linkbutton" icon="icon-save"
							onclick="addConTranDict();" plain="true">保存</a> 
				...
				<td>
					<table cellpadding="0" cellspacing="0" border="0" id="uiform"
						...
						<tr>
							...
							<td width="25%" class="form_content"><input type="text" id="sou_code" name="sou_code" style="width: 140px;"></input><font color="red"> *</font></td>
						</tr>
						<tr>
							<td width="25%" class="form_title">源系统说明：</td>
							<td width="25%" class="form_content"><input type="text" id="sou_desc" name="sou_desc" style="width: 140px;"></input><font color="red"> *</font></td>
						</tr>
						<tr>
							<td width="25%" class="form_title">源系统字典分类：</td>
							<td width="25%" class="form_content"><input type="text"
								id="sou_dict_code" name="sou_dict_code" style="width: 140px;"></input><font color="red"> *</font></td>
						</tr>
						<tr>
							<td width="25%" class="form_title">源系统字典分类说明：</td>
							<td width="25%" class="form_content"><input type="text"
								id="sou_dict_desc" name="sou_dict_desc" style="width: 140px;"></input><font color="red"> *</font></td>
						</tr>
						<tr>
							<td width="25%" class="form_title">源系统字典编码：</td>
							<td width="25%" class="form_content"><input type="text"
								id="sou_sub_dict_code" name="sou_sub_dict_code" style="width: 140px;"></input><font color="red"> *</font></td>
						</tr>
						<tr>
							<td width="25%" class="form_title">源系统字典编码说明：</td>
							<td width="25%" class="form_content"><input type="text"
								id="sou_sub_dict_desc" name="sou_sub_dict_desc" style="width: 140px;"></input><font color="red"> *</font></td>
						</tr>
						<tr>
