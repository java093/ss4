...
<script type="text/javascript" src="<%=baseUrl%>/pages/plan/plan_add.js"></script>
		...
		<form method="get" name="addPrivilegeForm" id="addPrivilegeForm" >
			...
			<table cellpadding="0" cellspacing="0" border="0" id="uiform" >
				<tr>
					...
					<td class="form_content"><input type="text" id="plan_name"  name="plan_name"/><font color="red">*</font></td>
				...
				<tr>
					...
					<input type="radio" name="plan_type" value="0" onclick="aCheck1()" checked="checked" /> 仅执行一次 &nbsp; 
					<input type="radio" name="plan_type" value="1" onclick="bCheck2()" /> 每天&nbsp; 
					<input type="radio" name="plan_type" value="2" onclick="bCheck3()" /> 每月 &nbsp;</td>
				</tr>
				<tr>
